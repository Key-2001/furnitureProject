        ...
        <>
            <section className='section-center home-title'>
                <article className='content'>
                    ...
                    <Link className='btn btn-product' to='/products'>shop now</Link>
                </article>
                <article className='img-container'>
                    <img src='https://react-course-comfy-sloth-store.netlify.app/static/media/hero-bcg.a876f19f.jpeg' alt='demo-img' className='main-img'/>
                    <img src='https://react-course-comfy-sloth-store.netlify.app/static/media/hero-bcg-2.78991864.jpeg' alt='demo-img-1' className='accent-img'/>
                </article>
            </section>
            {isLoading && <Loading/>}
